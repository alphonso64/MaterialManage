...
public class LoadingInfoCursorAdapter extends BaseAbstractRecycleCursorAdapter<RecyclerView.ViewHolder> {
    private Context context;

    public LoadingInfoCursorAdapter(Context context) {
        super(context, null);
    ...
    public static class CusViewHolder extends RecyclerView.ViewHolder {
        ...
        public CusViewHolder(View itemView, LoadingInfoCursorAdapter adapter) {
            super(itemView);
